...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>ServCli - IMP. MOVICEL CONIMA</title>
    <link
      rel="icon"
  ...
  <style>
    df-messenger {
      --df-messenger-bot-message: #f79743; /* El color de fondo de la burbuja para los mensajes del agente */
  ...
  <body>
    ...
    <df-messenger
      ...
      intent="WELCOME"
      chat-title="ServCli"
      agent-id="300d6b28-6a95-42d8-baf4-70b1ce47fe82"
      language-code="en"
    ></df-messenger>
  </body>
</html>
